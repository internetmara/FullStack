  ...
  render() {
    ...
    return (
        <div className="quantity-selector-wrapper">
          <button disabled="" data-test-id="segment-minus-button" data-testid="minus-button" aria-label="Reduce Quantity by 1" className="quantity-selector-button" onClick={this.decrement}>
          ...
          <button data-test-id="segment-plus-button" data-testid="plus-button" aria-label="Increase Quantity by 1" className="quantity-selector-button" onClick={this.increment}>
            <div className="sc-bdnxRM jvCTkj" style={{ width: 20, height: 20 }}>
