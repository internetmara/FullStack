      ...
      <div className='popup'>
        <div className='popup_inner'>
          <div>
            ...
            <div className='popup-gif'><iframe src="https://giphy.com/embed/pVM1TXCV1Jny1aSlcH" width="100" height="100" frameBorder="0" className="giphy-embed" allowFullScreen></iframe></div>
