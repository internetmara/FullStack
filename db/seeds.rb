...
harborside = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/Harborside.png')
dispensary1.photo.attach(io: harborside, filename: 'Harborside.png')
cookies = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/cookies.jpg')
dispensary2.photo.attach(io: cookies, filename: 'cookies.jpg')
medmen = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/medmen.jpg')
dispensary3.photo.attach(io: medmen, filename: 'medmen.jpg')
hightimes = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/hightimes.jpeg')
dispensary4.photo.attach(io: hightimes, filename: 'hightimes.jpeg')
blum = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/blum.jpeg')
dispensary5.photo.attach(io: blum, filename: 'blum.jpeg')
embarc = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/embarc.jpg')
dispensary6.photo.attach(io: embarc, filename: 'embarc.jpg')
stiiizy = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/stiiizy.jpg')
dispensary7.photo.attach(io: stiiizy, filename: 'stiiizy.jpg')
figthistle = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/figthistle.jpeg')
dispensary8.photo.attach(io: figthistle, filename: 'figthistle.jpeg')
eurekasky = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/eurekasky.jpg')
dispensary9.photo.attach(io: eurekasky, filename: 'eurekasky.jpg')
authentic415 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/authentic415.jpeg')
dispensary10.photo.attach(io: authentic415, filename: 'authentic415.jpeg')
apothecarium = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/apothecarium.jpg')
dispensary11.photo.attach(io: apothecarium, filename: 'apothecarium.jpg')
cbcb = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/dispensaries/cbcb.jpg')
...
icc = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/icc.png')
productA1.photo.attach(io: icc, filename: 'icc.png')
smokiez = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/smokiez.png')
productA2.photo.attach(io: smokiez, filename: 'smokiez.png')
theremedy = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/theremedy.png')
productA3.photo.attach(io: theremedy, filename: 'theremedy.png')
Nuvata = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Nuvata.png')
productA4.photo.attach(io: Nuvata, filename: 'Nuvata.png')
SelectElite = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/SelectElite.png')
productA5.photo.attach(io: SelectElite, filename: 'SelectElite.png')
Releaf = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Releaf.png')
productA6.photo.attach(io: Releaf, filename: 'Releaf.png')
gelonade = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/gelonade.png')
productB1.photo.attach(io: gelonade, filename: 'gelonade.png')
AnimasValleyLiveResin = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/AnimasValleyLiveResin.png')
productB2.photo.attach(io: AnimasValleyLiveResin, filename: 'AnimasValleyLiveResin.png')
kanha = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/kanha.png')
productB3.photo.attach(io: kanha, filename: 'kanha.png')
KingsGardenBananaOG = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KingsGardenBananaOG.png')
productB4.photo.attach(io: KingsGardenBananaOG, filename: 'KingsGardenBananaOG.png')
KnightsTemplar = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KnightsTemplar.png')
productB5.photo.attach(io: KnightsTemplar, filename: 'KnightsTemplar.png')
Canndescent = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Canndescent.png')
...
smokiez2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/smokiez.png')
productC1.photo.attach(io: smokiez2, filename: 'smokiez.png')
theremedy2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/theremedy.png')
productC2.photo.attach(io: theremedy2, filename: 'theremedy.png')
Nuvata2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Nuvata.png')
productC3.photo.attach(io: Nuvata2, filename: 'Nuvata.png')
SelectElite2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/SelectElite.png')
productC4.photo.attach(io: SelectElite2, filename: 'SelectElite.png')
Releaf2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Releaf.png')
productC5.photo.attach(io: Releaf2, filename: 'Releaf.png')
icc2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/icc.png')
productC6.photo.attach(io: icc2, filename: 'icc.png')

AnimasValleyLiveResin2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/AnimasValleyLiveResin.png')
productD1.photo.attach(io: AnimasValleyLiveResin2, filename: 'AnimasValleyLiveResin.png')
kanha2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/kanha.png')
productD2.photo.attach(io: kanha2, filename: 'kanha.png')
KingsGardenBananaOG2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KingsGardenBananaOG.png')
productD3.photo.attach(io: KingsGardenBananaOG2, filename: 'KingsGardenBananaOG.png')
KnightsTemplar2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KnightsTemplar.png')
productD4.photo.attach(io: KnightsTemplar2, filename: 'KnightsTemplar.png')
Canndescent2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Canndescent.png')
productD5.photo.attach(io: Canndescent2, filename: 'Canndescent.png')
gelonade2 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/gelonade.png')
...
theremedy3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/theremedy.png')
productE1.photo.attach(io: theremedy3, filename: 'theremedy.png')
Nuvata3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Nuvata.png')
productE2.photo.attach(io: Nuvata3, filename: 'Nuvata.png')
SelectElite3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/SelectElite.png')
productE3.photo.attach(io: SelectElite3, filename: 'SelectElite.png')
Releaf3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Releaf.png')
productE4.photo.attach(io: Releaf3, filename: 'Releaf.png')
icc3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/icc.png')
productE5.photo.attach(io: icc3, filename: 'icc.png')
smokiez3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/smokiez.png')
productE6.photo.attach(io: smokiez3, filename: 'smokiez.png')

kanha3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/kanha.png')
productF1.photo.attach(io: kanha3, filename: 'kanha.png')
KingsGardenBananaOG3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KingsGardenBananaOG.png')
productF2.photo.attach(io: KingsGardenBananaOG3, filename: 'KingsGardenBananaOG.png')
KnightsTemplar3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KnightsTemplar.png')
productF3.photo.attach(io: KnightsTemplar3, filename: 'KnightsTemplar.png')
Canndescent3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Canndescent.png')
productF4.photo.attach(io: Canndescent3, filename: 'Canndescent.png')
gelonade3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/gelonade.png')
productF5.photo.attach(io: gelonade3, filename: 'gelonade.png')
AnimasValleyLiveResin3 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/AnimasValleyLiveResin.png')
...
Nuvata4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Nuvata.png')
productG1.photo.attach(io: Nuvata4, filename: 'Nuvata.png')
SelectElite4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/SelectElite.png')
productG2.photo.attach(io: SelectElite4, filename: 'SelectElite.png')
Releaf4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Releaf.png')
productG3.photo.attach(io: Releaf4, filename: 'Releaf.png')
icc4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/icc.png')
productG4.photo.attach(io: icc4, filename: 'icc.png')
smokiez4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/smokiez.png')
productG5.photo.attach(io: smokiez4, filename: 'smokiez.png')
theremedy4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/theremedy.png')
productG6.photo.attach(io: theremedy4, filename: 'theremedy.png')

KingsGardenBananaOG4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KingsGardenBananaOG.png')
productH1.photo.attach(io: KingsGardenBananaOG4, filename: 'KingsGardenBananaOG.png')
KnightsTemplar4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KnightsTemplar.png')
productH2.photo.attach(io: KnightsTemplar4, filename: 'KnightsTemplar.png')
Canndescent4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Canndescent.png')
productH3.photo.attach(io: Canndescent4, filename: 'Canndescent.png')
gelonade4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/gelonade.png')
productH4.photo.attach(io: gelonade4, filename: 'gelonade.png')
AnimasValleyLiveResin4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/AnimasValleyLiveResin.png')
productH5.photo.attach(io: AnimasValleyLiveResin4, filename: 'AnimasValleyLiveResin.png')
kanha4 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/kanha.png')
...
SelectElite5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/SelectElite.png')
productI1.photo.attach(io: SelectElite5, filename: 'SelectElite.png')
Releaf5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Releaf.png')
productI2.photo.attach(io: Releaf5, filename: 'Releaf.png')
icc5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/icc.png')
productI3.photo.attach(io: icc5, filename: 'icc.png')
smokiez5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/smokiez.png')
productI4.photo.attach(io: smokiez5, filename: 'smokiez.png')
theremedy5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/theremedy.png')
productI5.photo.attach(io: theremedy5, filename: 'theremedy.png')
Nuvata5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Nuvata.png')
productI6.photo.attach(io: Nuvata5, filename: 'Nuvata.png')

KnightsTemplar5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KnightsTemplar.png')
productJ1.photo.attach(io: KnightsTemplar5, filename: 'KnightsTemplar.png')
Canndescent5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Canndescent.png')
productJ2.photo.attach(io: Canndescent5, filename: 'Canndescent.png')
gelonade5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/gelonade.png')
productJ3.photo.attach(io: gelonade5, filename: 'gelonade.png')
AnimasValleyLiveResin5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/AnimasValleyLiveResin.png')
productJ4.photo.attach(io: AnimasValleyLiveResin5, filename: 'AnimasValleyLiveResin.png')
kanha5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/kanha.png')
productJ5.photo.attach(io: kanha5, filename: 'kanha.png')
KingsGardenBananaOG5 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KingsGardenBananaOG.png')
...
Releaf6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Releaf.png')
productK1.photo.attach(io: Releaf6, filename: 'Releaf.png')
icc6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/icc.png')
productK2.photo.attach(io: icc6, filename: 'icc.png')
smokiez6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/smokiez.png')
productK3.photo.attach(io: smokiez6, filename: 'smokiez.png')
theremedy6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/theremedy.png')
productK4.photo.attach(io: theremedy6, filename: 'theremedy.png')
Nuvata6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Nuvata.png')
productK5.photo.attach(io: Nuvata6, filename: 'Nuvata.png')
SelectElite6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/SelectElite.png')
productK6.photo.attach(io: SelectElite6, filename: 'SelectElite.png')

Canndescent6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/Canndescent.png')
productL1.photo.attach(io: Canndescent6, filename: 'Canndescent.png')
gelonade6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/gelonade.png')
productL2.photo.attach(io: gelonade6, filename: 'gelonade.png')
AnimasValleyLiveResin6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/AnimasValleyLiveResin.png')
productL3.photo.attach(io: AnimasValleyLiveResin6, filename: 'AnimasValleyLiveResin.png')
kanha6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/kanha.png')
productL4.photo.attach(io: kanha6, filename: 'kanha.png')
KingsGardenBananaOG6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KingsGardenBananaOG.png')
productL5.photo.attach(io: KingsGardenBananaOG6, filename: 'KingsGardenBananaOG.png')
KnightsTemplar6 = open('https://hash-maps-seeds.s3.us-west-1.amazonaws.com/products/KnightsTemplar.png')
