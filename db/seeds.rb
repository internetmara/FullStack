...
product1 = Product.create(dispensary_id: 1, name: "Half Ounce Jar Ice Cream Cake", brand: "Humboldt's Finest", price: 120.00, category: "Flower", size: "per 1/2 oz", url: 'images/products/icc.png')
product2 = Product.create(dispensary_id: 1, name: "Sour Watermelon Fruit Chews - 100 mg THC - OK", brand: "Smokiez Edibles", price: 16.00, category: "Edibles", size: "10 pieces per package", url: 'images/products/smokiez.png')
product3 = Product.create(dispensary_id: 1, name: "The Remedy THC 1000mg (CA)", brand: "Mary's Medicinals", price: 50.00, category: "Tincture", size: "60 servings in a 15mL bottle", url: 'images/products/theremedy.png')
product4 = Product.create(dispensary_id: 1, name: "Full Mind - Strawberry", brand: "Nuvata", price: 40.00, category: "Disposable Vape Pen", size: "per 1/2 g", url: 'images/products/Nuvata.png')
product5 = Product.create(dispensary_id: 1, name: "Select Elite 1g Original Glue #4 - Hybrid", brand: "Select Oil", price: 30.00, category: "Cartridge", size: "per 1/2 g", url: 'images/products/SelectElite.png')
product6 = Product.create(dispensary_id: 2, name: "Pre-roll single - Gelonade - Indoor", brand: "Connected Cannabis Co.", price: 18.00, category: "Pre Roll", size: "1g", url: 'images/products/gelonade.png')
product7 = Product.create(dispensary_id: 2, name: "Animas Valley Live Resin", brand: "Raw Garden", price: 35.00, category: "Live Resin", size: "per 1 g", url: 'images/products/AnimasValleyLiveResin.png')
product8 = Product.create(dispensary_id: 2, name: "Kanha Indica Pink Lemonade Gummies 100mg", brand: "Kanha", price: 14.00, category: "Gummies", size: "10 pieces x 10mg/gummy", url: 'images/products/kanha.png')
product9 = Product.create(dispensary_id: 2, name: "Kings Garden - Banana OG", brand: "Apothecary Genetics", price: 30.00, category: "Shatter", size: "per 1 g", url: 'images/products/KingsGardenBananaOG.png')
product10 = Product.create(dispensary_id: 3, name: "Dark Heart Nursery - Clone - Knights Templar", brand: "Cali Kosher", price: 16.00, category: "Clone", size: "each", url: 'images/products/KnightsTemplar.png')